...
top_coordinates = []
bottom_coordinates = []
bounding_box_width_list = []
bounding_box_height_list = []
...
def draw_bounding_box_on_image(image,
  ...
  Args:
    ...
    use_normalized_coordinates: If True (default), treat coordinates
      ...
      coordinates as absolute.
  """
  global class_name_list, left_coordinates, right_coordinates, top_coordinates, bottom_coordinates, bounding_box_width_list, bounding_box_height_list
  ...
  draw.ellipse((left-2, top-2, left+2, top+2), width=1, fill=(255, 0, 0, 255))
  draw.ellipse((right-2, top-2, right+2, top+2), width=1, fill=(255, 0, 0, 255))
  draw.ellipse((left-2, bottom-2, left+2, bottom+2), width=1, fill=(255, 0, 0, 255))
  draw.ellipse((right-2, bottom-2, right+2, bottom+2), width=1, fill=(255, 0, 0, 255))
  ...
  for display_str in display_str_list[::-1]:
    ...
    """
    print("---------------------------------------------------------")
    print("Class: {}".format(display_str))
    print("Left: {0:.2f}".format(left))
    print("Right: {0:.2f}".format(right))
    print("Top: {0:.2f}".format(bottom))
    print("Bottom: {0:.2f}".format(top))
    print("Bounding Box width: {0:.2f}".format(right - left))
    print("Bounding Box height: {0:.2f}".format(bottom - top))
    """
    class_name_list.append(display_str)
    left_coordinates.append(left)
    right_coordinates.append(right)
    top_coordinates.append(top)
    bottom_coordinates.append(bottom)
    bounding_box_width_list.append(right - left)
    bounding_box_height_list.append(bottom - top)
    draw.rectangle(
  ...
  export_bounding_box_coordinates()
  
    
def export_bounding_box_coordinates():
	"""Exports the bounding box coordinates"""
	global class_name_list, left_coordinates, right_coordinates, top_coordinates, bottom_coordinates, bounding_box_width_list, bounding_box_height_list
	return [class_name_list, left_coordinates, right_coordinates, top_coordinates, 									  				bottom_coordinates, bounding_box_width_list, bounding_box_height_list]
